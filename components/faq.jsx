    ...
    <section className="relative max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center">
      ...
      >
        ...
        <p className="max-w-xl text-foreground/80 text-center">
          Do you have any question before or after purchasing Infinity AntiCheat? You can find the most asked questions here!
        </p>
      </motion.div>
      <motion.div
        initial={{ y: 5, opacity: 0 }}
      ...
      >
        ...
        >
          <AccordionItem key="1" aria-label="detections" title="Can Infinity AntiCheat Detect Cheat ?">
            Since cheats are rapidly evolving, Infinity AntiCheat cannot detect specific cheats, however, you can
            configure it to detect most used options in cheats, like protecting your server events or changing
            the object blacklist.
          </AccordionItem>
          <AccordionItem key="2" aria-label="help" title="I have an issue with Infinity AntiCheat!">
            If you have any issues with Infinity AntiCheat, don't worry, you can always contact our
            support team through our <a href="https://discord.gg/q4w4pHfPFU" style={{ color: "#9B7EDE" }}>Discord Server</a>. We'll gladly
            help you and hopefully resolve your issue!
          </AccordionItem>
          <AccordionItem key="4" aria-label="refund" title="Is it possible to get a refund?">
            ...
            If you're allegible for a refund, please open a ticket on our <a href="https://discord.gg/q4w4pHfPFU" style={{ color: "#9B7EDE" }}>Discord Server</a>. Attempting to
            chargeback or opening a PayPal dispute will automatically put you on the blacklist from our store!
          </AccordionItem>
          <AccordionItem key="6" aria-label="updates" title="How often does Infinity AntiCheat receive updates?">
            We attempt to update Infinity AntiCheat as frequently as possible. The AntiCheat receives 3 types of updates: <br /><br />
