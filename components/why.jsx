    ...
    <section className="relative max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center">
      ...
      >
        <Card className="max-w-[400px] rounded-2xl">
          ...
          <CardBody>
            <p>Infinity AntiCheat is perfectly optimised for every server and won't use more than <b>0.03</b>ms on your resmon</p>
          </CardBody>
        </Card>
        ...
        <Card className="max-w-[400px] rounded-2xl">
          ...
          <CardBody>
            <p>Infinity AntiCheat is made to be affordable for everyone, you don't need to pay 300$+ for an anticheat!</p>
          </CardBody>
        </Card>
        ...
        <Card className="max-w-[400px] rounded-2xl">
          ...
          <CardBody>
            <p>To run Infinity AntiCheat you don't need any specific frameworks, you can install this on any server, whether it's running on ESX, QB, OX Core, it doesn't matter!
            </p>
          </CardBody>
        </Card>
