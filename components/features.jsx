...
export default function Faq() {
  const features = [
    ...
    { name: "Anti Thermal Vision", description: "Anti Thermal Vision", value: true },
  ...
  const adminmenu = [
    ...
    { name: "Tracers", description: "Draw lines leading to nearby players", value: true },
    ...
    <section className="relative max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center">
      ...
      >
        ...
        <p className="max-w-xl text-foreground/80 text-center">
          Do you want to know if Infinity AntiCheat has a specific function you"d like to use?
        </p>
      </motion.div>
      <motion.div
        initial={{ y: 5, opacity: 0 }}
      ...
      >
        ...
        >
          ...
          <p className="max-w-xl text-foreground/80 text-center">
            Infinity AntiCheat also includes an admin menu, here are it"s features
          </p>
          <br/>
          </motion.div>
          <Table aria-label="Features" shadow="lg" width="100%" isStriped={true}>
