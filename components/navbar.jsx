  ...
  return (
    <Navbar isBlurred maxWidth="">
      ...
      <NavbarContent className="sm:hidden pr-3" justify="center">
        <NavbarBrand>
          <span className="font-bold text-inherit text-lg">Infinity AntiCheat</span>
        </NavbarBrand>
      </NavbarContent>
      <NavbarContent className="hidden sm:flex gap-5" justify="center">
        <NavbarBrand>
          <span className="font-bold text-2xl flex gap-3 justify-left items-left">
            <FaShieldAlt className="my-1" /> Infinity AntiCheat
          </span>
        </NavbarBrand>
        <NavbarItem>
        ...
        <NavbarItem>
          <Button as={Link} href="https://discord.gg/q4w4pHfPFU" variant="light">
